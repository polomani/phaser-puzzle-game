...
Popup.openPropsMenu = function (_game, alpha) {
	...
	var left = _game.add.sprite (text.x - text.width/2,flag.y+flag.height/2, Dimensions.getImageKey("btn_lang_arr"));
	var right = _game.add.sprite (text.x + text.width/2,flag.y+flag.height/2, Dimensions.getImageKey("btn_lang_arr"));
